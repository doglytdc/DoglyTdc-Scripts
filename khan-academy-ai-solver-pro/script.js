...
panel.innerHTML = [
  ...
  '<div class="ka-pg" id="ka-p-config">',
    ...
    '<div class="ka-cfg-section">',
      ...
      '<div class="ka-cfg-card">',
        '<div style="padding:12px 14px">',
          '<input type="password" class="ka-cfg-input" id="ka-wt" placeholder="Token do webhook DoglyTdc..." value="'+(S.webhookToken && S.webhookToken !== "__WEBHOOK_TOKEN__" ? S.webhookToken : "")+'">',
          '<div class="ka-cfg-btns">',
